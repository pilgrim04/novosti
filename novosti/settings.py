...
DATABASES = {
    'default': {
        ...
        'NAME': 'novosti',                      # Or path to database file if using sqlite3.
        'USER': 'postgres',                      # Not used with sqlite3.
        'PASSWORD': 'LK1DSB2q',                  # Not used with sqlite3.
...
SECRET_KEY = '7a-n(2!sg*32up-&hwepa^jukh-u_e^61%18(6x4l&4(07bple'
...
ROOT_URLCONF = 'novosti.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'novosti.wsgi.application'
